...
#phylogeny
tree<-read.nexus('../RBD_aa_tree/Sarbecovirus_RBD.tree')
...
#trait data
inf <- read.csv("Sarbecovirus_infectivity_profile.csv", header = T, row.names = 1)
...
pdf("Sarbecovirus_ACE2_usage_range_estimation.pdf")
